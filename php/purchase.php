...
<body style="background-color: #FECD45; font-family: 'Karla'">
    ...
    <br><br><br>
 	...
 	<h1 style="color: #2568FB;">Purchase</h1><br><br>
    ...
    <?php 
        ...
        $invoiceSelect = "SELECT invoiceNo FROM purchase ORDER BY id DESC LIMIT 1";
        // echo $invoiceSelect;
	...
	<div class="form1">
		<form action="userPurchase.php" method="post">
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
			...
			Firm Name: <input type="text" name="name" required><br><br>
            ...
            Discount: <input type="text" name="discount" value=0 required><br><br>
